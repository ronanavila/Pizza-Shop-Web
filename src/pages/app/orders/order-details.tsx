...
export function OderDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle> Pedido: 415564564sdgfdg</DialogTitle>
      ...
      <div className="space-y-6">
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              <TableCell>Piza 5 Queijos</TableCell>
            ...
            <TableRow>
              <TableCell>Piza Portuguesa</TableCell>
